...
let render = reactDom.render;
            let unmountComponentAtNode = reactDom.unmountComponentAtNode;
            let batchedUpdates = reactDom.unstable_batchedUpdates;
            let findDOMNode = reactDom.findDOMNode;
            let hydrate = reactDom.hydrate;

export { render, unmountComponentAtNode, batchedUpdates, findDOMNode, hydrate };export default reactDom;
